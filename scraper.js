...
// Updated: January 6, 2026 - Added Summer 2026 codes
// ============================================
const discountCodePeriods = {
    ...
    '11324': { start: new Date('2026-05-01'), end: new Date('2026-10-04') },
    '11323': { start: new Date('2026-05-26'), end: new Date('2026-09-15') }
};
...
// ============================================
// DISCOUNT LABELS FOR EMAIL TEMPLATES
// Updated: January 6, 2026 - Added Summer 2026 labels
// ============================================
const discountLabels = {
    '11296': 'Fall 2025 Discount',
    '11313': 'Spring 2026 Discount',
    '11316': 'Spring 2026 Package Discount',
    '11324': 'Summer 2026 Room Discount',
    '11323': 'Summer 2026 Package Discount'
};
...
<img src="http://cdn.mcauto-images-production.sendgrid.net/bde4f566d6ba3b93/edb013f5-7136-417c-abf0-60ea49ab3464/600x300.png" alt="Mouse Agents" width="150" height="75" style="width:150px;height:75px;display:block;margin:0 auto 5px;">
...
<div style="text-align:center;margin:20px 0;">
<a href="https://www.disneytravelagents.com/" style="background:#1BC5D4;color:#fff;text-decoration:none;padding:12px 25px;border-radius:5px;display:inline-block;margin-right:10px;">
Reserve This Room
</a>
<a href="https://mouseagents.com/room-finder/dashboard/" style="background:#1F202D;color:#fff;text-decoration:none;padding:12px 25px;border-radius:5px;display:inline-block;">
Manage Alerts
</a>
</div>
</div>
...
// Optimized: Skip discount searches when room-only returns zero results
// ============================================
async function scrapeResorts() {
    ...
    // Group by resort (keeps long delays only between resorts)
